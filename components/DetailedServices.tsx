...
import { ArrowLeft, CheckCircle2, Globe, ShoppingCart, BarChart3, Rocket, Zap, Target } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div 
          className="mt-32 p-16 rounded-[80px] bg-[#1c1e21] text-center text-white"
